  ...
  ui <-
    material_page(
      ...
      tags$div(
        ...
        #   inputId = "input_floating_button1"
        # )
        # material_floating_button(
        #   inputId = "floating_button1"
        # )
        #
        # material_input(
        #   type = "floating_button",
        #   inputId = "input_floating_button2",
        #   icon = "cloud",
        #   depth = 5,
        #   color = "blue"
        # )
        # material_floating_button(
        #   inputId = "floating_button2",
        #   icon = "cloud",
        #   depth = 5,
        #   color = "blue"
        # ),
        ...
        material_input(
          type = "password_box",
          inputId = "input_password_box1",
          label = "input_password_box1"
        ),
        material_password_box(
          inputId = "password_box1",
          label = "password_box1"
        ),

        material_input(
          type = "password_box",
          inputId = "input_password_box2",
          label = "input_password_box2",
          color = "red"
        ),
        material_password_box(
          inputId = "password_box",
          label = "password_box_red",
          color = "#ef5350"
        ),
        # material_floating_button(
        #   inputId = "example_floating_button",
        #   icon = "mode_edit",
        #   depth = 5,
        #   color = "red lighten-2"
        # ),
        ...
        material_input(
          type = "radio-button",
          inputId = "input_example_radio_button1",
          label = "Radio Button",
          choices = c(
            "Cake" = "c",
            "Pie" = "p",
        ...
        material_input(
          type = "radio-button",
          inputId = "input_example_radio_button2",
          label = "Radio Button",
          choices = c(
            "Cake" = "c2",
            "Pie" = "p2",
        ...
        material_input(
          type = "dropdown",
          inputId = "input_example_dropdown1",
          label = "Drop down",
          choices = c(
            "Chicken" = "c1",
            "Steak" = "s1",
        ...
        # file input --------------------------------------------------------------
        material_file_input(
          inputId = "example_file_input",
          label = "File",
          color = "#2196f3"
        ),
        material_file_input(
          inputId = "example_file_input2",
          label = "File"
        ),
        material_button(inputId = "update_text_test_button",
                        label = "update text"),
        material_text_box(inputId = "update_text_test",
                          label = "text"),
        plotOutput('testPlot'),
        material_button(inputId = "update_dropdown_test_button",
                        label = "update dropdown"),
        material_dropdown(inputId = "update_dropdown_test",
                          label = "test",
                          choices = c(
                            "A 1" = "a",
                            "B 1" = "o k")),
        ...
        material_button(inputId = "update_number_box_test_button",
                        label = "update number box"),
        material_number_box(inputId = "update_number_box_test",
                            label = "test",
                            min_value = 1,
                            max_value = 50,
                            initial_value = 2),
        ...
        material_button(inputId = "update_password_test_button",
                        label = "update password"),
        material_password_box(inputId = "update_password_test",
                              label = "text"),
        plotOutput('testPasswordPlot'),


        material_button(inputId = "update_switch_test_button",
                        label = "update switch"),
        material_switch(inputId = "update_switch_test",
                        label = "text", initial_value = FALSE),
        plotOutput('testSwitchPlot'),

        material_button(inputId = "update_radio_button_test_button",
                        label = "update radio button"),
        material_radio_button(inputId = "update_radio_button_test",
                              label = "text",choices = c("Adf" =  "a_update", "Bdf" = "b_update")),
        plotOutput('testRadioButtonPlot'),

        material_button(inputId = "update_slider_test_button",
                        label = "update slider"),
        material_slider(inputId = "update_slider_test",
                              label = "slider",
                              min_value = 5,
                        max_value = 20,
                        initial_value = 8),
        ...
        material_button(inputId = "update_checkbox_test_button",
                        label = "update checkbox"),
        material_checkbox(inputId = "update_checkbox_test",
                        label = "checkbox",
                        initial_value = FALSE),
        plotOutput('testCheckboxPlot'),

        material_button(inputId = "update_date_picker_test_button",
                        label = "update date_picker"),
        material_date_picker(inputId = "update_date_picker_test",
                          label = "date_picker"),
  ...
  server <- function(input, output, session) {
    ...
    observeEvent(input$update_number_box_test_button, {
      update_material_number_box(
        session,
        inputId = "update_number_box_test",
        value = 10
      )
    })
    ...
    observeEvent(input$update_radio_button_test_button, {
      ...
      update_material_radio_button(session,
                                   inputId = "update_radio_button_test",
                                   value = "b_update")
    ...
    observeEvent(input$update_date_picker_test_button, {
      ...
      update_material_date_picker(session,
                               inputId = "update_date_picker_test",
                               value = "10 April, 2012")
