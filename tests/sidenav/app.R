  ...
  ui <- material_page(
    ...
    material_sidenav(
      ...
      navlist = list(
        ...
        list(target = "lisk_4.html", icon = "alarm", active = TRUE),
        c(target = "lisk_5.html", icon = "archive", class = "waves-effect waves-light btn red lighten-3 round", name = "Download"),
        list(name = "Collapsible", icon = "add_box", class = "accordion",
             collapsible = list(
                c(target = "lisk_1.html", name = "One"),
                c(target = "lisk_2.html", name = "Two"),
                c(target = "lisk_3.html", name = "Three", icon = "cloud"),
        ...
        list(name = "Collapsible Popout", icon = "apps", class = "popout",
             collapsible = list(
                c(target = "lisk_1.html", name = "One"),
                c(target = "lisk_2.html", name = "Two"),
                c(target = "lisk_3.html", name = "Three", icon = "cloud"),
        ...
        list(name = "Collapsible Expandable", icon = "apps", class = "expandable",
             collapsible = list(
               c(target = "lisk_1.html", name = "One"),
               c(target = "lisk_2.html", name = "Two"),
               c(target = "lisk_3.html", name = "Three", icon = "cloud"),
