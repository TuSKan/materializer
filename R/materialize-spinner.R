...
material_spinner_hide <- function(session, output_id){
  ...
  session$sendCustomMessage(
    type = "materializeJS",
    paste0(
      "$('#", paste0(output_id, '-materialize-spinner'), "').remove();"
    )
  )
