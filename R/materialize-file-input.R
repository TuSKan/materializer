...
#'
#' }
material_file_input <- function(inputId,
                                label = "File",
                                color = NULL) {
      ...
      shiny::tagList(
        shiny::tags$head(
          shiny::tags$style(
            paste0(
              '
    input[name=materialize-file-path-wrapper-', inputId, ']:not(.browser-default).valid{
        ...
        shiny::tags$div(
          ...
          shiny::tags$div(
            ...
            shiny::tags$input(
              ...
              type="text",
              name = paste0("materialize-file-path-wrapper-", inputId)
            )
          )
        ),
        file_input_style
