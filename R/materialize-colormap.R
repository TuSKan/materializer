#' Convert color material to hexcode color
#'
#' Color material to hexcode color
#' @param color String. The input identifier used to access the value.
#' @export
material_colormap <- function(color) {
  if (is.null(color)) return("")
  switch(
    trimws(as.character(color)),
